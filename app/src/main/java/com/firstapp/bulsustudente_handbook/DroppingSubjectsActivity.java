...
public class DroppingSubjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dropping_subjects);
        ...
        // Set header title
        headerTitle.setText("DROPPING OF SUBJECTS");
