...
public class AcademicDelinquencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academic_delinquency);
        ...
        // Set header title
        headerTitle.setText("ACADEMIC DELINQUENCY");
