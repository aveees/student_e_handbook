...
public class CoedActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_coed);

        // Header Setup
        ImageView backBtn = findViewById(R.id.menu_icon);
        TextView headerTitle = findViewById(R.id.header_title);
        headerTitle.setText("College of Education");
        ...
        // Set adapter
        CoedViewPagerAdapter adapter = new CoedViewPagerAdapter(this);
