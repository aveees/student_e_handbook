...
public class GraduationAwardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graduation_awards);
        ...
        // Set header title
        headerTitle.setText("GRADUATION AWARDS");
