...
public class MaximumResidencyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maximum_residency);
        ...
        // Set header title
        headerTitle.setText("MAXIMUM RESIDENCY REQUIREMENT");
