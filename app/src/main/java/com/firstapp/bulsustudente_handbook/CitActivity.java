...
public class CitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerTitle.setText("College of Industrial Technology");
        ...
        // Set adapter
        CitViewPagerAdapter adapter = new CitViewPagerAdapter(this);
