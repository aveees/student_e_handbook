...
public class SubstitutionSubjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_substitution_subjects);
        ...
        // Set header title
        headerTitle.setText("SUBSTITUTION OF SUBJECTS");
