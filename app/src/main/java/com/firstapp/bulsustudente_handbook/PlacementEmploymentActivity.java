...
public class PlacementEmploymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_placement_employment);
        ...
        headerTitle.setText("PLACEMENT AND EMPLOYMENT");
