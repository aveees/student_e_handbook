...
public class CommencementExercisesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commencement_exercises);
        ...
        // Set header title
        headerTitle.setText("COMMENCEMENT EXERCISES");
