...
public class TransparencyCorrectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transparency_correction);
        ...
        // Set header title
        headerTitle.setText("TRANSPARENCY AND CORRECTION OF GRADES");
