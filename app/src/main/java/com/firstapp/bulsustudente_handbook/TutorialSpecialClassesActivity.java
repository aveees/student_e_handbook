...
public class TutorialSpecialClassesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_special_classes);
        ...
        // Set title
        headerTitle.setText("TUTORIAL AND SPECIAL CLASSES");
