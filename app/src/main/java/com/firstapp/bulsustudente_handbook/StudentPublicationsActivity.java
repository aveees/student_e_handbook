...
public class StudentPublicationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_publications);
        ...
        headerTitle.setText("STUDENT PUBLICATIONS");
