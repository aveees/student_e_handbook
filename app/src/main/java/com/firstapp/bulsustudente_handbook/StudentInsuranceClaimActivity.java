...
public class StudentInsuranceClaimActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_insurance_claim);
        ...
        headerTitle.setText("STUDENT INSURANCE CLAIM");
        breadcrumbs.setText("STUDENT WELLFARE");
